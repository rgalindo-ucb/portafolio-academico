          ...
          <div className="home-final-reflection premium-panel overflow-hidden">
            ...
            <div className="relative z-10 p-8 sm:p-10 lg:p-14">
              ...
              <p className="mt-8 max-w-3xl text-base leading-8 text-foreground/76">
                A lo largo del semestre, cada materia aportó una forma distinta de mirar los problemas: desde el análisis de organizaciones y el liderazgo de personas, hasta la interpretación de datos y la construcción de soluciones digitales. Este portafolio refleja ese proceso de aprendizaje, mostrando cómo los trabajos desarrollados fueron construyendo una base más clara para analizar, comunicar y tomar decisiones.
              </p>
